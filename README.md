...
### Linux/macOS
```sh
bash <(curl -Ls https://raw.githubusercontent.com/z-5888/s-ui/main/install.sh)
```

### Windows
1. 从 [GitHub Releases](https://github.com/z-5888/s-ui/releases/latest) 下载最新 Windows 版本。
2. 解压 ZIP 文件。
...
### Linux/macOS
1. 根据你的系统和架构，从 GitHub 获取最新版本 S-UI：[https://github.com/z-5888/s-ui/releases/latest](https://github.com/z-5888/s-ui/releases/latest)
2. **可选：** 获取最新版 `s-ui.sh`：[https://raw.githubusercontent.com/z-5888/s-ui/main/s-ui.sh](https://raw.githubusercontent.com/z-5888/s-ui/main/s-ui.sh)
...
### Windows
1. 从 GitHub 获取最新 Windows 版本：[https://github.com/z-5888/s-ui/releases/latest](https://github.com/z-5888/s-ui/releases/latest)
...
```shell
git clone https://github.com/z-5888/s-ui
docker build -t s-ui .
```
...
#### 鸣谢原作者：[alireza0/s-ui](https://github.com/alireza0/s-ui)  [admin8800/s-ui](https://github.com/admin8800/s-ui)
